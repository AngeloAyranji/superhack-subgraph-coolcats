...
export class GiveAwayCall extends ethereum.Call {
  get inputs(): GiveAwayCall__Inputs {
    return new GiveAwayCall__Inputs(this);
  }

  get outputs(): GiveAwayCall__Outputs {
    return new GiveAwayCall__Outputs(this);
  }
}

export class GiveAwayCall__Inputs {
  _call: GiveAwayCall;

  constructor(call: GiveAwayCall) {
    this._call = call;
  }
...
export class GiveAwayCall__Outputs {
  _call: GiveAwayCall;
